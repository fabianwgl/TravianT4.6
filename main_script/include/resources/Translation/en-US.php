...
<div>This ban could be temporary cause of overclick, in that case will be removed automatically after 5 seconds.
    ...
    <br>
    <br>For more info contact <a href="messages.php?t=1&id=4">Multihunter</a> or <a href="messages.php?t=1&id=1">Support</a> or sent email to <b>redacted@example.invalid</b>.
    <br>
    <br>Best regards</div>
';
