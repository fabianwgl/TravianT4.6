...
<div>این ممکن است به دلیل تعداد کلیلک های بالا اتفاق افتاده باشد که موقتی خواهد بود, در اینصورت ظرف مدت 5 ثانیه این مشکل خود به خود حل میشود.
    ...
    <br>
    <br>برای اطلاعات بیشتر با <a href="messages.php?t=1&id=4">مولتی هانترها</a> یا <a href="messages.php?t=1&id=1">پشتیبانی</a> تماس بگیرید و یا به ادمین از طریق <b>redacted@example.invalid</b> ایمیل بفرستید
    <br>
    <br>با تشکر</div>
';
