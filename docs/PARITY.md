...
| Combat and hero | Combat strength, walls, hero bonuses, travel, artifacts, and simulator vectors remain deterministic | `main_script/include/Model/BattleModel.php`, `main_script/include/Controller/RallyPoint/Simulator.php`, `main_script/include/Game/Hero` | `tests/formula-golden-regression.php`, `tests/runtime-regression.php` | verified |
