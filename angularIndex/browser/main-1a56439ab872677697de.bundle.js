webpackJsonp(["main"], {
        ...
        var a = n("./node_modules/@angular/core/esm5/core.js"),
            ...
            f = function() {
                function e(e, t, n, a, r, s, i, c) {
                    this.http = e, this.cacheService = t, this.cookieService = n, this.modalService = a, this.injector = r, this.platformId = s, this.document = i, this.forwardedHost = c, Object(d.isPlatformServer)(this.platformId) ? void 0 === this.forwardedHost || null == this.forwardedHost || (-1 !== this.forwardedHost.indexOf("citvian.org") ? this.apiUrl = "https://api.citvian.org/v1/" : -1 !== this.forwardedHost.indexOf("turbotra.ir") ? this.apiUrl = "http://api.turbotra.ir/v1/" : -1 !== this.forwardedHost.indexOf("turbotra.com") ? this.apiUrl = "https://api.turbotra.com/v1/" : -1 !== this.forwardedHost.indexOf("kingstorm.net") ? this.apiUrl = "https://api.kingstorm.net/v1/" : -1 !== this.forwardedHost.indexOf("openvillage.net") ? this.apiUrl = "https://api.openvillage.net/v1/" : -1 !== this.forwardedHost.indexOf("travian-wars.com") ? this.apiUrl = "https://api.travian-wars.com/v1/" : -1 !== this.forwardedHost.indexOf("example.com") ? this.apiUrl = "https://api.example.com/v1/" : -1 !== this.forwardedHost.indexOf("tstravian.ir") ? this.apiUrl = "http://api.tstravian.ir/v1/" : -1 !== this.forwardedHost.indexOf("speedtra.com") ? this.apiUrl = "https://api.speedtra.com/v1/" : -1 !== this.forwardedHost.indexOf("travian.live") ? this.apiUrl = "https://api.travian.live/v1/" : console.log("Could not detect api url")) : this.apiUrl = this.document.location.protocol + "//api." + this.document.location.hostname.replace("www.", "") + "/v1/", (null === this.apiUrl || void 0 === this.apiUrl || this.apiUrl.length <= 0 || -1 !== this.apiUrl.indexOf("localhost") || -1 !== this.apiUrl.indexOf("127.0.0.1")) && (this.apiUrl = "https://api.example.com/v1/"), o.a.production || this.cacheService.removeAll()
                }
    ...
    "./src/frontend/locale/el-GR.json": function(e, t) {
        e.exports = {
            ...
            KEYWORDS: "Travian,Onlime game,strategy game,multiplayer game,Romans,Teutens,Guals,Aspidanetwork,openvillage,Citvian,Travian speed,SpeedTra, SpeedTravian, Travian games, MultiSpeed",
            JOURNEY: {
                PLAY_NOW: {
